...
/* Dynamic inputs js start */
function ieInput()
{
	var inputs = document.getElementsByTagName("input");
	for(var i=0;i<inputs.length;i++)
	{
		if(inputs[i].className.indexOf("dynamic") !=-1)
		{
...
if (window.addEventListener)
	window.addEventListener("load", ieInput, false);
else if (window.attachEvent)
	window.attachEvent("onload", ieInput);
/* Dynamic inputs js end */
